...
var ChicagoComponent = /** @class */ (function () {
    ...
    ChicagoComponent.prototype.ngOnInit = function () {
        var _this = this;
        var observable = this._httpService.getPath("Chicago");
...
var DcComponent = /** @class */ (function () {
    ...
    DcComponent.prototype.ngOnInit = function () {
        var _this = this;
        var observable = this._httpService.getPath("District of Columbia");
        observable.subscribe(function (x) {
            // this.route.params.subscribe(y=>{
            //   console.log(y);
            // })
...
var SanjoseComponent = /** @class */ (function () {
    ...
    SanjoseComponent.prototype.ngOnInit = function () {
        var _this = this;
        var observable = this._httpService.getPath("San Jose");
        observable.subscribe(function (x) {
            // this.route.params.subscribe(y=>{
            //   console.log(y);
            // })
...
var TaskComponent = /** @class */ (function () {
    ...
    TaskComponent.prototype.ngOnInit = function () {
        var _this = this;
        var observable = this._httpService.getPath("Task");
        observable.subscribe(function (x) {
            // this.route.params.subscribe(y=>{
            //   console.log(y);
            // })
...
var TulsaComponent = /** @class */ (function () {
    ...
    TulsaComponent.prototype.ngOnInit = function () {
        ...
        var observable = this._httpService.getPath("tulsa");
        observable.subscribe(function (x) {
            // this.route.params.subscribe(y=>{
            //   console.log(y);
            // })
...
module.exports = __webpack_require__(/*! C:\Users\Christian Heath\desktop\mean\angular\weatherapi\public\src\main.ts */"./src/main.ts");
